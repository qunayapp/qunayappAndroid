...
class HomeServiceAdapter(private val categorias:ArrayList<Categorias>, private val promocionBanner: PromocionBanner, private var listener:(Categorias)->Unit ):
    ...
    class HomeServiceAdapterHolder(view: View): RecyclerView.ViewHolder(view){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return HomeServiceAdapterHolder(view)
    }

    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        /*holder as HomeServiceAdapterHolder
